...
SELECT models.name, models.brand_name, headquarters FROM models JOIN brands ON models.brand_name = brands.name WHERE models.name = 'Mustang' AND models.brand_name = 'Ford';
...
SELECT brands.name, brands.founded, models.name FROM brands LEFT JOIN models ON models.brand_name = brands.name WHERE brands.discontinued IS NULL;
...
SELECT models.name, models.brand_name, brands.founded FROM models JOIN brands ON models.brand_name = brands.name;
